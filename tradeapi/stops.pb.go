...
func (x *Stop) GetExpirationDate() *timestamppb.Timestamp {
	if x != nil {
...
func (x *Stop) GetAcceptedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.AcceptedAt
	}
	return nil
...
func (x *Stop) GetCanceledAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CanceledAt
	}
	return nil
...
func (x *NewStopRequest) GetExpirationDate() *timestamppb.Timestamp {
	if x != nil {
		return x.ExpirationDate
	}
	return nil
...
var file_proto_tradeapi_v1_stops_proto_rawDesc = []byte{
	...
	0x10, 0x02, 0x42, 0x4a, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d,
	0x2f, 0x65, 0x76, 0x73, 0x61, 0x6d, 0x73, 0x6f, 0x6e, 0x6f, 0x76, 0x2f, 0x46, 0x69, 0x6e, 0x61,
	0x6d, 0x54, 0x72, 0x61, 0x64, 0x65, 0x47, 0x6f, 0x2f, 0x76, 0x32, 0x2f, 0x74, 0x72, 0x61, 0x64,
	0x65, 0x61, 0x70, 0x69, 0xaa, 0x02, 0x17, 0x46, 0x69, 0x6e, 0x61, 0x6d, 0x2e, 0x54, 0x72, 0x61,
	0x64, 0x65, 0x41, 0x70, 0x69, 0x2e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x56, 0x31, 0x62, 0x06,
