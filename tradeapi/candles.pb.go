...
func (x *IntradayCandle) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
func (x *IntradayCandleInterval) GetFrom() *timestamp.Timestamp {
	if x != nil {
		return x.From
	}
	return nil
...
func (x *IntradayCandleInterval) GetTo() *timestamp.Timestamp {
	if x != nil {
		return x.To
	}
	return nil
...
var file_proto_tradeapi_v1_candles_proto_rawDesc = []byte{
	...
	0x42, 0x27, 0x5a, 0x0b, 0x2e, 0x2f, 0x3b, 0x74, 0x72, 0x61, 0x64, 0x65, 0x61, 0x70, 0x69, 0xaa,
